...
int TemperatureSensor::getBinaryBit() const
{
  int binary;
...
int TemperatureSensor::calcTemp() const
{
  int rawTemp;
  int temp;
  ...
  temp = (int)((rawTemp * 0.09770396 - 50)*100); // Calculate actual temperature in deg C * 100
